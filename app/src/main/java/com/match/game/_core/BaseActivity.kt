...
import com.match.game.BuildConfig
import com.match.game.R
...
/*
Базовый класс, который будут расширять остальные активити клоаки, функции logevent и fetchremoteconfig не особо то нужны
основная нужная функция тут - getvaluesfromdatabase чтобы вытягивать ссылку из базы данных
 */